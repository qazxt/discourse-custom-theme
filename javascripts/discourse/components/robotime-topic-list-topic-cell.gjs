...
import RobotimeTopicMeta from "./robotime-topic-meta";

/* global settings */

export default class RobotimeTopicListTopicCell extends Component {
  @service currentUser;
  @service messageBus;
  ...
  get metaEnabled() {
    try {
      ...
      return s.robotime_topic_meta_enabled !== false && s.robotime_topic_meta_enabled !== "false";
    } catch (e) {
      return true;
    }
  }
  ...
  <template>
    <td
      class="main-link clearfix topic-list-data robotime-topic-list-topic-cell"
      colspan="1"
    >
      <div class="robotime-topic-preview-content">
        <div class="robotime-topic-preview-content__outlet robotime-topic-preview-content__outlet--before-link">
          <PluginOutlet
        ...
        <div class="robotime-topic-content__footer">
          {{#if this.metaEnabled}}
        ...
        <div class="robotime-topic-preview-content__outlet robotime-topic-preview-content__outlet--main-link-bottom">
          <PluginOutlet
